...
- [x] G1: every glyph the source renders is captured in the page inventory
  ...
  EXPECT: RESULT: PASS
  EVIDENCE: automatic-evidence=v1; definition-sha256=3e1e8db92ed1e0732754091a7484c0f04ba4c4e346e983745605e8b71d9cf902; exit=0; EXPECT=matched; output-sha256=d87db8037c27bd3d2137586a4eaf68b1fd09fec08a75d8e4174efd275ef18f28; output-bytes=139; shell=/bin/sh; cwd=/home/claude/obc; path=2d5a7faa1724/9 entries
...
- [x] G4: provision numbering runs without an unexplained gap anywhere in the tree
  ...
  EXPECT: RESULT: PASS
  EVIDENCE: automatic-evidence=v1; definition-sha256=10824042256f2fba1cca376fd108c24f967cae1c7dfe53042c7b98c840b94a0f; exit=0; EXPECT=matched; output-sha256=dc0347e69f664b3171168463c69012391d904adc85ad0b3a93d6ab3f289f292a; output-bytes=65; shell=/bin/sh; cwd=/home/claude/obc; path=2d5a7faa1724/9 entries

- [x] G5: content text lands in the node tree rather than being dropped
  CHECK: python3 checks/check4_capture.py
  EXPECT: RESULT: PASS
  EVIDENCE: automatic-evidence=v1; definition-sha256=fb69210e9f948ea1edfe1a6fc53104bd3ce316165bf86649f991bfc61d6697d1; exit=0; EXPECT=matched; output-sha256=411838d7958bb45bb3ee4b3aadce3342fca6444a0451ea3c0da91899a91092b7; output-bytes=116; shell=/bin/sh; cwd=/home/claude/obc; path=2d5a7faa1724/9 entries
...
- [x] G7: every citation resolves or carries a reason code, with no parse failures
  ...
  EXPECT: RESULT: PASS
  EVIDENCE: automatic-evidence=v1; definition-sha256=586694e0ee9d7b9534e353f7e709e45309bce2b5153670eb654e30ec911db0e6; exit=0; EXPECT=matched; output-sha256=5cf941b095503bfeebf8cd464835e3b74c224bce8946312b1bde44dbab8f04f9; output-bytes=390; shell=/bin/sh; cwd=/home/claude/obc; path=2d5a7faa1724/9 entries

- [x] G8: the model-built PDF is a strict superset of the hand-patched build
  CHECK: python3 checks/check8_build.py
  EXPECT: RESULT: PASS
  EVIDENCE: automatic-evidence=v1; definition-sha256=5a4ee0be9e5236192f9c63ad28decd95ccf53f004e1d7cc742140ab70e8c3be6; exit=0; EXPECT=matched; output-sha256=5663aa80a99548b139910dfc87a59e81b3f83785698c16e0b611b8cb46eeaf8d; output-bytes=518; shell=/bin/sh; cwd=/home/claude/obc; path=2d5a7faa1724/9 entries
...
- [x] G11: the Index is parsed into entries with resolving citations
  ...
  EXPECT: RESULT: PASS
  EVIDENCE: automatic-evidence=v1; definition-sha256=8e3bc31c39c082120e53c330857079bb2c0f7e34ba253dcc2af5857658ee1c3d; exit=0; EXPECT=matched; output-sha256=d4a613abd27d9973f954050872f41c45a33d62e774870d49934a34a518a5b2f7; output-bytes=246; shell=/bin/sh; cwd=/home/claude/obc; path=2d5a7faa1724/9 entries
...
- [x] G12: the shipped file opens freely, is correctly protected, and keeps its text layer
  ...
  EXPECT: RESULT: PASS
  EVIDENCE: automatic-evidence=v1; definition-sha256=8e0438dd38efe3ab8a33ba39b2e43114f5ef295aa2d71aebc808f9c0494ca2a0; exit=0; EXPECT=matched; output-sha256=6059530c21ea020997693f7c352318a6750e984180fb56a5beb7aeb9d50a21c2; output-bytes=366; shell=/bin/sh; cwd=/home/claude/obc; path=2d5a7faa1724/9 entries
...
- [x] G15: references whose targets live in Volume 2 resolve
  CHECK: python3 /home/claude/obc2/checks/check14_crossvol.py
  EXPECT: RESULT: PASS
  EVIDENCE: automatic-evidence=v1; definition-sha256=654879aea0c6e825f95cafadba35e50fa30c91fbb904f576f77398ed0bab82d9; exit=0; EXPECT=matched; output-sha256=40c5f864313675c4edfe295a9238532036c2203a91a0ce06ec5f2ebc10958a82; output-bytes=308; shell=/bin/sh; cwd=/home/claude/obc2; path=2d5a7faa1724/9 entries
  CWD: /home/claude/obc2

- [ ] G16: markdown, html and sqlite emitters are written
  EVIDENCE: pending
