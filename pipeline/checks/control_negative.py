...
SRC = "/mnt/user-data/uploads/301880.pdf"
LAB = os.environ.get("OBC_LABELS", os.path.normpath(os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "..", "verify", "data", "v1", "labels.json")))
d = pymupdf.open(SRC)
k = Counter()
for p in d:
